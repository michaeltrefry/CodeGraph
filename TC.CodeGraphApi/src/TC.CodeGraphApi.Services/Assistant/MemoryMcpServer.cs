...
public class MemoryMcpServer
{
    ...
    [Description("""
        ...
        """)]
    public static string StoreMemory(
        [Description("Username to scope the memory (e.g. 'michael')")] string username,
        ...
        [Description("Maximum number of entities to return (default 20)")] int maxNodes = 20)
    {
        ...
        var result = await memoryService.QueryAsync(username.ToLowerInvariant(), topic, hops, maxNodes);
