...
public class MemoryController(MemoryService memoryService, ITcServiceBus serviceBus) : Controller
{
    [HttpPost("store")]
    public IActionResult Store(string username, [FromBody] MemoryExtractionResult extraction, [FromQuery] string? source)
    {
        ...
        serviceBus.Publish(new StoreMemory
        {
