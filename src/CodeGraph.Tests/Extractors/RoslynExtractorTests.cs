...
public class RoslynExtractorTests
{
    ...
    [Fact]
    public void Detects_EntityNameAttribute_RoutingMetadata()
    {
        var code = """
            using System;
            ...
            {
                public EntityNameAttribute(string queueName, string exchangeName, string virtualHost) { }
            }

            namespace MyApp.Events
            {
                [EntityName("order-created-queue", "order-exchange", "/orders")]
                public class OrderCreatedEvent
                {
                    public int OrderId { get; set; }
                }
        ...
        classNode.Properties["is_message_contract"].ShouldBe(true);
    ...
    [Fact]
    public void Detects_EntityNameAttribute_NamedArguments()
    {
        var code = """
            using System;
            ...
            namespace MyApp.Events
            {
                [EntityName(QueueName = "payment-queue", RoutingKey = "payment.completed")]
    ...
    [Fact]
    public void Detects_MassTransitPublish_CreatesPublishesEdge()
    {
        var code = """
            ...
            namespace MyApp.Services
            {
                ...
                public class OrderService
                {
                    ...
                    {
                        await _publishEndpoint.Publish(new MyApp.Events.OrderShippedEvent());
                    }
                }
            }
            """;
