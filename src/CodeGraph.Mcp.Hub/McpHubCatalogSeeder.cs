...
public sealed class McpHubCatalogSeeder(IMcpHubStore store, IMcpSensitiveColumnStore sensitiveColumnStore)
{
    ...
    [
        ...
        ShortcutWrite("stories-stage-file", "Stage Shortcut story file", "Create a short-lived staged attachment from caller-provided content."),
        ShortcutWrite("stories-upload-file", "Upload Shortcut story file", "Attach a previously staged file by opaque handle."),
