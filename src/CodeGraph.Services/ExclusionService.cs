...
public interface IExclusionService
{
    ...
    /// </summary>
    Task<string?> GetExclusionTypeAsync(string repoName, string? sourceGroup);
    ...
    : IExclusionService
{
    ...
    public async Task<string?> GetExclusionTypeAsync(string repoName, string? sourceGroup)
    {
        ...
        {
            var segments = sourceGroup.ToLowerInvariant().Split('/');
