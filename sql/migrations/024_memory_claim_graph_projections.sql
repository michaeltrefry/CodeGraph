...
CREATE INDEX IF NOT EXISTS ix_memory_active_claims_username_fact_group_key
    ON memory_active_claims (username, fact_group_key);

CREATE INDEX IF NOT EXISTS ix_memory_seed_aliases_username_normalized_alias
    ON memory_seed_aliases (username, normalized_alias);

CREATE INDEX IF NOT EXISTS ix_memory_seed_aliases_username_entity_id
    ON memory_seed_aliases (username, entity_id);

CREATE INDEX IF NOT EXISTS ix_memory_entity_adjacency_username_from_entity_edge_type
    ON memory_entity_adjacency (username, from_entity_id, edge_type);

CREATE INDEX IF NOT EXISTS ix_memory_entity_adjacency_username_to_entity_edge_type
