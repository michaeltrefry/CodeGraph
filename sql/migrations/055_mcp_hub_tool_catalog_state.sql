...
ALTER TABLE mcp_hub_tools
    ADD COLUMN IF NOT EXISTS is_available BOOLEAN NOT NULL DEFAULT TRUE AFTER enabled,
    ADD COLUMN IF NOT EXISTS default_selected BOOLEAN NOT NULL DEFAULT FALSE AFTER is_available,
    ADD COLUMN IF NOT EXISTS access_class VARCHAR(32) NOT NULL DEFAULT 'read' AFTER default_selected;
