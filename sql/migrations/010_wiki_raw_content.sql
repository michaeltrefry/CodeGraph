...
ALTER TABLE wiki_sections
    ADD COLUMN IF NOT EXISTS has_raw_content BOOLEAN NOT NULL DEFAULT FALSE AFTER allow_user_pages;
...
ALTER TABLE wiki_pages
    ADD COLUMN IF NOT EXISTS raw_content MEDIUMTEXT NULL AFTER content;
